...
export default function Home() {
  return (
    <div className="p-10">
      ...
      <div className="border-1 rounded-xl border-gray-400 shadow-2xl">
      ...
      <div className="border-1 rounded-xl mt-5 border-gray-400 shadow-2xl">
        <div className="p-5">
          <p className="text-gray-600">List Manga</p>
